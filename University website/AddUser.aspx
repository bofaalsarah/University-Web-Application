      ...
      <h2>Add Teacher/Student</h2>
          <form id="form1" runat="server">
              <div style="display:inline-block;">
                  ...
                  <asp:TextBox ID="username" runat="server" CssClass="formright"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Username field is mandatory." ControlToValidate="username" CssClass="emailerror" ValidationGroup="addForm"></asp:RequiredFieldValidator><br /><br />
                  ...
                  <asp:TextBox ID="country" runat="server" CssClass="formright"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Country field is mandatory." ControlToValidate="country" CssClass="emailerror" ValidationGroup="addForm"></asp:RequiredFieldValidator><br /><br />
                  <asp:Label ID="Label7" runat="server" Text="Email:" style="font-weight: 700"></asp:Label>
                  <asp:TextBox ID="email" runat="server" CssClass="formright"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Email field is mandatory." ControlToValidate="email" CssClass="emailerror" ValidationGroup="addForm"></asp:RequiredFieldValidator>
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="(.+)@(.+)\.(.+)" CssClass="emailerror" ErrorMessage="Email is in an improper form." ControlToValidate="email" ValidationGroup="addForm"></asp:RegularExpressionValidator><br /><br />
                  <asp:Label ID="Label8" runat="server" Text="Contact #:" style="font-weight: 700"></asp:Label>
                  <asp:TextBox ID="contactno" runat="server" CssClass="formright"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Contact # field is mandatory." ControlToValidate="contactno" CssClass="emailerror" ValidationGroup="addForm"></asp:RequiredFieldValidator>
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Number is in an improper form." CssClass="emailerror" ControlToValidate="contactno" ValidationExpression="[0-9]{10}" ValidationGroup="addForm"></asp:RegularExpressionValidator><br /><br />
                  <asp:Label ID="Label10" runat="server" Text="Image:" style="font-weight: 700"></asp:Label>
                  <asp:FileUpload ID="FileUpload1" runat="server" /><asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Image field is mandatory." ControlToValidate="FileUpload1" CssClass="emailerror" ValidationGroup="addForm"></asp:RequiredFieldValidator><br /><br />
                  <asp:Button ID="Button2" runat="server" Text="Add Teacher/Student" OnClick="Button2_Click" ValidationGroup="addForm" />
              </div>
        <br class="clear" />
      </div>
    </div>
...
<script>
        ...
        if (type == "error") {
            if (val == "1") {
                message = "A teacher with the same username already exists."
            }
            if (val == "2") {
