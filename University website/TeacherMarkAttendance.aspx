<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherMarkAttendance.aspx.cs" Inherits="TeacherMarkAttendance" %>
      ...
      <h2>Mark Attendance</h2>
        ...
        <asp:Label ID="Label1" runat="server" Text="Course:"></asp:Label>
          <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="changeValues" AutoPostBack="true"></asp:DropDownList><br /><br />
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="select id, username, firstName, lastName from Student where id in (select studentId from Student_Course where courseId = @cid)">
                  <selectparameters>
