...
<div class="wrapper col1">
  ...
  <center>
    <div id="logo1">
      <h1><a href="Admin.aspx"><img id="logoimg" src="images/logo.png" alt=""/></a></h1>
    </div>
    </center>
    <br class="clear" />
  </div>
    ...
    <div class="fl_left">
      ...
      <h2>Services</h2>
        <ul>
          <li>
          <center>
            <div><img src="images/add.png" alt="" style="width:130px;height:130px;" /></div>
            <p><a href="AddUser.aspx">Add Teacher/Student</a></p>
            </center>
          </li>
          <li class="last">
          <center>
            <div><img src="images/editAttendance.png" alt=""  style="width:130px;height:130px;"/></div>
            <p><a href="ViewAllAttendance.aspx">View/Edit Attendance</a></p>
            </center>
          </li>
          <li>
          <center>
            <div><img src="images/subject.png" alt="" style="width:130px;height:130px;" /></div>
            <p><a href="ViewAllMaterials.aspx">View Course Materials</a></p>
            </center>
          </li>
          <li class="last">
          <center>
            <div><img src="images/manage.png" alt="" style="width:130px;height:130px;" /></div>	
            <p><a href="ManageUserInfo.aspx">Manage Teacher/Student Information</a></p>
            </center>
          </li>
                    <li>
          <center>
            <div><img src="images/marks.png" alt="" style="width:130px;height:130px;" /></div>
            <p><a href="PublishResults.aspx">Publish Student Results</a></p>
            </center>
          </li>
          <li class="last">
          <center>
            <div><img src="images/viewCourseResults.png" alt="" style="width:130px;height:130px;" /></div>	
            <p><a href="StudentsResults.aspx">View Course Results</a></p>
            </center>
          </li>
