    ...
    <div class="fl_left">
      ...
      <h2>My Attendance</h2>
        <form id="form1" runat="server">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="select Course.name, Student_Attendance.sessionDate, Student_Attendance.attended from Course, Student_Attendance where Course.id in (select courseId from Student_Attendance) and Student_Attendance.studentId = @sid">
                <selectparameters>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:BoundField DataField="sessionDate" HeaderText="Session Date" SortExpression="sessionDate"></asp:BoundField>
                    <asp:CheckBoxField DataField="attended" HeaderText="Attended"></asp:CheckBoxField>
