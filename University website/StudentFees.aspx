    ...
    <div class="fl_left">
      ...
      <h2>My Fees</h2>
        <form id="form1" runat="server">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="select total, paid, outstanding, fine from Fees where studentId = @sid">
                <selectparameters>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:BoundField DataField="outstanding" HeaderText="Outstanding" SortExpression="outstanding"></asp:BoundField>
